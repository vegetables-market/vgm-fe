...
export default function StockEditPage() {
  ...
  return (
    <div className="mx-auto mt-8 max-w-2xl rounded-lg bg-white p-6 shadow-md">
      <h1 className="mb-6 text-2xl font-bold text-gray-800">在庫の編集</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <div className="relative mt-1 rounded-md shadow-sm">
                ...
                <input
                  type="number"
                  className="block w-full rounded-md border-gray-300 p-2 pl-7 focus:border-green-500 focus:ring-green-500 sm:text-sm"
                  placeholder="0"
                  value={price}
            ...
            <div>
              ...
              <input
                type="number"
                className="mt-1 block w-full rounded-md border-gray-300 p-2 focus:border-green-500 focus:ring-green-500 sm:text-sm"
                value={quantity}
        ...
        <div className="flex gap-4 pt-6">
          <button
            ...
            className="flex-1 rounded-md border border-gray-300 bg-white px-4 py-3 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50"
          >
            キャンセル
          </button>
          <button
