        ...
        return (
            <div className="min-h-screen bg-background flex items-center justify-center p-4">
                <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-8 max-w-md w-full text-center shadow-xl">
                    ...
                    <h1 className="text-2xl font-bold mb-2 text-gray-900 dark:text-white">購入が完了しました</h1>
        ...
        <div className="min-h-screen bg-background text-foreground">
            ...
            <header className="border-b border-gray-200 dark:border-gray-700 py-4 px-6 bg-white dark:bg-gray-900">
                <div className="max-w-6xl mx-auto flex items-center">
                    <Link href="/products" className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors flex items-center gap-2">
            ...
            <main className="max-w-6xl mx-auto p-4 md:p-8">
                <h1 className="text-2xl font-bold mb-8" style={{ color: 'inherit' }}>購入の確認</h1>

                <div className="grid lg:grid-cols-3 gap-8">
                    {/* 左側：商品情報と支払い方法 */}
                    <div className="lg:col-span-2 space-y-6">
                        {/* 注意事項 */}
                        <div className="rounded-lg p-4 flex items-start gap-3" style={{ backgroundColor: 'rgb(254 243 199)', border: '1px solid rgb(217 119 6)' }}>
                            <svg className="w-6 h-6 flex-shrink-0 mt-0.5" style={{ color: 'rgb(146 64 14)' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L3.732 16.5c-.77.833.192 2.5 1.732 2.5z" />
                            </svg>
                            <div>
                                <p className="text-sm font-bold" style={{ color: 'rgb(120 53 15)' }}>お支払い前にご確認ください</p>
                                <p className="text-sm" style={{ color: 'rgb(146 64 14)' }}>商品内容をご確認の上、購入を確定してください。</p>
                            </div>
                        </div>
                        ...
                        <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4 flex gap-4 shadow-sm">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-gray-500 dark:text-gray-400 text-sm">{product.producer}</p>
                                <p className="text-red-500 font-bold mt-1">
                                    ¥{product.price.toLocaleString()}
                                    <span className="text-gray-400 text-xs ml-1">(税込) 送料込み</span>
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4 shadow-sm">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <span className="text-gray-700 dark:text-gray-300">**** **** **** 1234</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6 sticky top-4 shadow-sm">
                            <div className="space-y-4 mb-6">
                                ...
                                <div className="flex justify-between border-t border-gray-200 dark:border-gray-700 pt-4">
                                    <span className="font-bold text-gray-900 dark:text-white">支払い金額</span>
                            ...
                            <p className="text-xs text-gray-500 mb-4">
                                ...
                                <span className="text-blue-500">プライバシーポリシー</span>に同意の上、ご購入ください。
                            </p>
...
export default function PurchasePage() {
    return (
        <Suspense fallback={<div className="min-h-screen bg-background flex items-center justify-center text-gray-900 dark:text-white">読み込み中...</div>}>
            <PurchaseContent />
        </Suspense>
    );
}
