...
export default function MfaPage() {
  ...
  const [step, setStep] = useState<"status" | "qr" | "verify" | "backup">(
    "status",
  );
            ...
            <div>
              ...
              {!mfaStatus.isEnabled ? (
                <button
                  ...
                  disabled={loading}
                  className="rounded bg-blue-500 px-6 py-3 font-bold text-white hover:bg-blue-600 disabled:opacity-50"
                >
                ...
                <button
                  onClick={disableMfa}
                  disabled={loading}
                  className="rounded bg-red-500 px-6 py-3 font-bold text-white hover:bg-red-600 disabled:opacity-50"
                >
                  {loading ? "処理中..." : "MFAを無効化"}
                </button>
              )}
          ...
          {step === "qr" && setupData && (
            <div>
              ...
              <button
                ...
                className="rounded bg-blue-500 px-6 py-3 font-bold text-white hover:bg-blue-600"
              >
                次へ
              </button>
            </div>
          ...
          {step === "verify" && (
            <div>
              ...
              <input
                ...
                placeholder="123456"
                className="mb-6 w-full rounded border-2 border-gray-300 px-4 py-2 text-center text-2xl tracking-widest"
                maxLength={6}
              />
              ...
              <div className="flex gap-4">
                <button
                  onClick={() => setStep("qr")}
                  className="rounded bg-gray-300 px-6 py-3 font-bold text-black hover:bg-gray-400"
                >
                  戻る
                </button>
                <button
                  ...
                  className="flex-1 rounded bg-blue-500 px-6 py-3 font-bold text-white hover:bg-blue-600 disabled:opacity-50"
                >
                  {loading ? "検証中..." : "確認"}
                </button>
              </div>
            ...
            <div>
              ...
              <div className="flex gap-4">
                ...
                <button
                  ...
                  className="flex-1 rounded bg-blue-500 px-6 py-3 font-bold text-white hover:bg-blue-600"
                >
                  完了
                </button>
              </div>
