...
export const PURCHASE_ITEM = {
  ...
  producer: "地元農家",
  category: "Vegetables",
  description: "地元の農家が丁寧に育てた新鮮な有機野菜の詰め合わせセットです。トマト、キュウリ、ナス、ピーマンなど季節の野菜が入っています。",
  imageUrl: "https://images.unsplash.com/photo-540420773420-3366772f4999?auto=format&fit=crop&w=800"
};