  ...
  return (
    <div>
      <div className="mb-4 text-center">
        <h2 className="mb-2 text-xl font-bold">メールアドレスの確認</h2>
        <p className="mb-2 text-xs text-gray-400">
          {formData.email} 宛に認証コードを送信しました。
          <br />
          コードを入力して次へ進んでください。
        </p>
        {timeLeft !== null && (
          <p
            className={`font-mono text-sm ${timeLeft < 60 ? "text-red-500" : "text-gray-300"}`}
          >
        ...
        <div className="mb-6 flex justify-center">
          <OtpInput
            ...
            renderInput={(props: any) => (
              <input
                {...props}
                className="mx-1 !h-12 !w-10 rounded border border-zinc-700 bg-zinc-900 text-center text-xl focus:border-white focus:outline-none"
              />
            )}
