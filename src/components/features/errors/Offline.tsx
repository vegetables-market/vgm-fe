    ...
    <div className="flex h-full min-h-[50vh] flex-col items-center justify-center bg-gray-50 p-4 text-center dark:bg-gray-900">
      <div className="flex flex-col items-center space-y-4">
        ...
        <button
          ...
          className="mt-4 rounded-lg bg-blue-600 px-6 py-2 font-medium text-white transition-colors hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:outline-none dark:focus:ring-offset-gray-900"
        >
          再読み込み
        </button>
      </div>
