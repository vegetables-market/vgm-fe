...
const VARIANT_CLASS: Record<AuthSubmitButtonVariant, string> = {
  primary:
    "bg-foreground text-surface hover:bg-gray-200 disabled:bg-disabled-foreground!",
...
export default function AuthSubmitButton({
  ...
  return (
    <button
      ...
      className={`mb-3 h-10 w-full cursor-pointer rounded-full text-base font-bold transition-colors disabled:cursor-not-allowed disabled:opacity-50 ${VARIANT_CLASS[variant]} ${className}`}
      {...props}
    >
