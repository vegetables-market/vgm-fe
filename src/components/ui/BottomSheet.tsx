      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed right-0 bottom-0 left-0 z-50 flex max-h-[90vh] flex-col rounded-t-[20px] bg-white text-gray-900 shadow-xl dark:bg-gray-900 dark:text-white"
            style={{ y: 0 }} // 初期値リセット用
          >
            {/* Drag Handle */}
