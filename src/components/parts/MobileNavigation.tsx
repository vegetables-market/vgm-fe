    ...
    return (
        <nav className="w-full fixed bottom-0 block lg:hidden">
            <nav className="flex items-center justify-around h-16 max-w-md mx-auto ">
                <Link href="/" className="flex flex-col items-center justify-center w-full h-full transition-all text-emerald-600">
                    <div className="relative"><i className="fa-solid fa-house text-xl mb-0.5"></i></div>
                    <span className="text-[10px] font-medium">ホーム</span></Link>
                ...
                <Link href="/listing" className="flex flex-col items-center justify-center w-full h-full transition-all relative -top-4">
                    ...
                    <span className="text-[10px] font-bold text-emerald-600 mt-5">出品</span></Link>
                <button className="flex flex-col items-center justify-center w-full h-full transition-all text-slate-400">
                ...
                <Link href="/profile" className="flex flex-col items-center justify-center w-full h-full transition-all text-slate-400">
                    <div className="relative"><i className="fa-solid fa-user text-xl mb-0.5"></i></div>
                    <span className="text-[10px] font-medium">マイページ</span></Link>
            </nav>
